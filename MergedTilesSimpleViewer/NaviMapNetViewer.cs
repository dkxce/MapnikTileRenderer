...
namespace NaviMapNet
{
    public partial class NaviMapNetViewer : UserControl
    {
        ...
        /// <summary>
        ///     Получение векторных слоев карты (заэкранного)
        /// </summary>
        [Browsable(false)]
        ...
        public NaviMapNetViewer()
        {
            ...
            // Map Bars
            zoomLevels.Image = global::MergedTilesSimpleViewer.Properties.Resources.ZoomLevels;
        ...
        public void ReloadMap()
        {
            ...
            if (ImageSourceType_ == ImageSourceTypes.tiles) // TILES
            {
                ...
                mm.UseDiskCache = this.UseDiskCache && (ImageSourceService_ != MapServices.Custom_LocalFiles);
                mm.CacheSubDirectory = ((int)ImageSourceService_).ToString("X8");
    ...
    internal static class MapCursors
    {
        ...
        public static Cursor ZoomIn
        {
            get
            {
                System.IO.MemoryStream ms = new System.IO.MemoryStream(MergedTilesSimpleViewer.Properties.Resources.zoom_in);
        ...
        public static Cursor ZoomOut
        {
            get
            {
                System.IO.MemoryStream ms = new System.IO.MemoryStream(MergedTilesSimpleViewer.Properties.Resources.zoom_out);
                Cursor c = new Cursor(ms);
                ms.Close();
                return c;
            }
    ...
    internal class MapMerger
    {
        ...
        public Image GetMap()
        {
            ...
            try
            {
                // Find where to draw the center tile...
                int drawx, drawy;
