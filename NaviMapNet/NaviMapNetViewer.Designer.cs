namespace NaviMapNet
{
    partial class NaviMapNetViewer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.hideSelBox,
            this.HSB,
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem,
            ...
            this.btnCopyToolStripMenuItem.Text = "”становить координаты центра карты...";
            ...
            this.setMapXYZToolStripMenuItem.Text = "”становить тайл центра карты...";
            ...
            this.getCursorLatLonToolStripMenuItem.Text = "”становить координаты курсора...";
            ...
            this.showAddit.Text = "¬спомогательна€ информаци€ по точке...";
            ...
            this.openExternalToolStripMenuItem.Text = "ќткрыть тайл во внешнем просмоторщике...";
            ...
            this.selBoxInfo.Text = "»нформаци€ по области выделени€...";
            ...
            this.save2Shp.Text = "—охранить область выделени€ в файл...";
            ...
            this.Zoom2Sel.Text = "”величить зону выделени€ и в центр";
            ...
            this.hideSelBox.Text = "”брать область выделени€";
            ...
            // 
            // вернутьс€¬Ќормальный–ежимToolStripMenuItem
            // 
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem.Name = "вернутьс€¬Ќормальный–ежимToolStripMenuItem";
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem.Size = new System.Drawing.Size(327, 22);
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem.Text = "¬ернутьс€ в нормальный режим";
            this.вернутьс€¬Ќормальный–ежимToolStripMenuItem.Click += new System.EventHandler(this.вернутьс€¬Ќормальный–ежимToolStripMenuItem_Click);
            // 
            // ShowNaviChangeBtn
            // 
            ...
            this.ShowNaviChangeBtn.Text = "–ежим навигации по карте";
            // 
            // mttShift
            // 
            ...
            this.mttShift.Text = "—двиг (стандарт)";
            ...
            this.mttZoomIn.Text = "”величение (приближение)";
            ...
            this.mttZoomOut.Text = "”меньшение (отдаление)";
            ...
            this.ShowZoomBtn.Text = "ќтображать шкалу масштаба";
            ...
            this.ShowZoomsBtn.Text = "ќтображать масштабные уровни";
            ...
            this.ShowCrossBtn.Text = "ќтображать перекрестие в центре карты";
            ...
            this.ShowTileBorderBtn.Text = "ќтображать границы тайлов";
            ...
            this.ShowXYZBtn.Text = "ќтображать нумерацию тайлов";
            ...
            this.ShowUseCacheBtn.Text = "»спользовать встроенное кэширование тайлов";
            ...
            this.openCacheFolderToolStripMenuItem.Text = "ќткрыть папку с кэшем...";
            ...
            this.saveMapImgToolStripMenuItem.Text = "—охранить карту как картинку...";
            ...
            this.saveBoundsShapeToolStripMenuItem.Text = "—охранить область карты в файл...";
            ...
            this.ShowReloadTilesBtn.Text = "ѕерегрузить тайлы";
            ...
            this.labelLoading.Image = global::NaviMapNet.Properties.Resources.Globe;
        ...
        private System.Windows.Forms.ToolStripMenuItem вернутьс€¬Ќормальный–ежимToolStripMenuItem;
